...
| M2 | Consolidate crypto (re-scoped to deletion per ADR-0013) | 8 | 4 | 🟡 In progress — T2.0, T2.1, T2.7, T2.9, T2.10 done; T2.2/T2.3/T2.6 cancelled per ADR-0013; T2.4, T2.5, T2.8 open |
