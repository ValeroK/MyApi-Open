                      ...
                      {signupStep === 3 && (
                        <div className="space-y-4">
                          <div className="rounded-xl border border-slate-700/80 bg-slate-900/60 p-4 mb-4">
                            ...
                            <p className="text-xs text-slate-500 mt-2 italic">Example: \"I'm a product manager based in London. I prefer async communication and work best in the morning.\"</p>
                          </div>
                          <textarea
                            value={userMdText}
