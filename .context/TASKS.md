...
| M3 | OAuth state + PKCE + callback hardening | 10 | 7 | 🟡 In progress — Steps 1–5 / T3.0–T3.6 done (T3.0 + T3.1 + T3.2 + T3.3 2026-04-21; T3.4 + T3.5 + T3.6 paired in a single commit 2026-04-23); Steps 6–8 / T3.7–T3.9 pending |
